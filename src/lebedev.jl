...
function genOh_a00(v)
    "(0,0,a) etc. (6 points)"
    a=1.0
    hcat([a,0,0,v],[-a,0,0,v],[0,a,0,v],[0,-a,0,v],[0,0,a,v],[0,0,-a,v])'
end

function genOh_aa0(v)
    "(0,a,a) etc, a=1/sqrt(2) (12 points)"
    a=sqrt(0.5)
    hcat([0,a,a,v],[0,-a,a,v],[0,a,-a,v],[0,-a,-a,v],
         [a,0,a,v],[-a,0,a,v],[a,0,-a,v],[-a,0,-a,v],
         [a,a,0,v],[-a,a,0,v],[a,-a,0,v],[-a,-a,0,v])'
 end

function genOh_aaa(v)
    "(a,a,a) etc, a=1/sqrt(3) (8 points)"
    a = sqrt(1./3.)
    hcat([a,a,a,v],[-a,a,a,v],[a,-a,a,v],[-a,-a,a,v],
         [a,a,-a,v],[-a,a,-a,v],[a,-a,-a,v],[-a,-a,-a,v])'
 end

function genOh_aab(v,a)
    "(a,a,b) etc, b=sqrt(1-2 a^2), a input (24 points)"
    b = sqrt(1.0 - 2.0*a*a)
    hcat([a,a,b,v],[-a,a,b,v],[a,-a,b,v],[-a,-a,b,v],
...
function genOh_ab0(v,a)
    "(a,b,0) etc, b=sqrt(1-a^2), a input (24 points)"
    b=sqrt(1.0-a*a)
    hcat([a,b,0,v],[-a,b,0,v],[a,-b,0,v],[-a,-b,0,v],
...
function genOh_abc(v,a,b)
    "(a,b,c) etc, c=sqrt(1-a^2-b^2), a,b input  (48 points)"
    c=sqrt(1.0 - a*a - b*b)
    hcat([a,b,c,v],[-a,b,c,v],[a,-b,c,v],[-a,-b,c,v],
...
function leb74()
    [genOh_a00(0.5130671797338464E-3);
...
function leb86()
    [genOh_a00(0.1154401154401154E-1);
...
function leb110()
    [genOh_a00(0.3828270494937162E-2);
...
function leb146()
    [genOh_a00(0.5996313688621381E-3);
...
function leb170()
    [genOh_a00(0.5544842902037365E-2);
...
function leb194()
    [genOh_a00(0.1782340447244611E-2);
...
# generate lebedev grids
function generate_lebedev()
